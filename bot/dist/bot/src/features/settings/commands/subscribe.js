 ...
 */
const handleAlbumSelection = async (albumData, channelId, guildId, alreadySubscribed) => {
 ...
 */
export const onAlbumSelectionComplete = async (albumData, interaction, alreadySubscribed) => {
